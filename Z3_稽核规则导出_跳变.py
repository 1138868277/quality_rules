...
def fetch_data_from_db():
    ...
    table_name = f'{AREA}区域.import_list_tb'
...
if __name__ == "__main__":
    ...
    if data_df is not None:
        merge_columns_hierarchical(
            df=data_df,
            output_file=f'/Users/liuhaojun/Documents/项目文档/中国华电项目(云南)/04 时序数据治理/01 测点数据标准/{AREA_FILE}/00 总体/{AREA}区域_时序稽核质量规则_跳变.xlsx',
